...
public class ConfigGenerator {
    ...
    /** Generates a topic with a specified name and number of partitions, default
    ...
    /** Generates a topic with a specified name, number of partitions, and replication factor
     *
