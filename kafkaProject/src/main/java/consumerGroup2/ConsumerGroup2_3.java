...
public class ConsumerGroup2_3
{

    private static final Logger log = LoggerFactory.getLogger(ConsumerGroup2_3.class.getSimpleName());

    public static void main(String[] args)
    {

        Logger log = LoggerFactory.getLogger(ConsumerGroup2_3.class.getName());
